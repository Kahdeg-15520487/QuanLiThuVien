namespace QuanLiThuVien.XuliTheDocGia {
	partial class CapNhatTheDocGia {
		...
		private void InitializeComponent() {
			...
			this.button_LapThe = new System.Windows.Forms.Button();
			...
			this.textBox_HoTen.TabIndex = 22;
			// 
			// label6
			// 
			...
			this.textBox_DiaChi.TabIndex = 25;
			// 
		...
		private System.Windows.Forms.Button button_LapThe;
